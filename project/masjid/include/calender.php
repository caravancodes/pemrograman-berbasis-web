<?php
	...
	echo '<table id="wp-calendar" summary="Calendar" align="center" border="0" width="100%" cellpadding=1 cellspacing=1 style="border:1px solid #CCCCCC" bgcolor="#FFFFFF"><tr style="font-family:arial;font-size:10px;"><td align=center><font color="#CC6633">';
