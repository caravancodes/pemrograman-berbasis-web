...
<div id="post">
    <h1 class="title">::[ Input Muzaki ]::</h1>
        ...
        <form name="frm_unit" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            <?php
                ...
                if($action == "TAMBAH"){
                    ...
                    $_sql         	= "SELECT * FROM muzaqi WHERE id='$id'";
            ...
            <table width="100%" align="center">
                <tr class="head">
                    <td width="25%" >Nama Muzaki</td><td width="">:</td>
		...
		<tr class="head">
		    ...
		    $id             = trim($_POST['id']);
                    ...
                    if ((!empty($nama))&&(!empty($jk))&&(!empty($pendidikan))&&(!empty($tmp_lahir))
                        ...
                        switch($_GET['action']) {
                            case "TAMBAH":
                                Tambah(" muzaqi ","'','$nama','$jk','$pendidikan','$tmp_lahir','$tgl_lahir','$alamat','$pekerjaan'", " muzaqi " );
                                echo"<html><head><title></title><meta http-equiv='refresh' content='1;URL=?act=InputMuzaqi&action=TAMBAH'></head><body></body></html>";
                                break;
                            case "UBAH":
                                Ubah(" muzaqi "," nama='$nama',jk='$jk',pendidikan='$pendidikan',pekerjaan='$pekerjaan',
					tmp_lahir='$tmp_lahir',tgl_lahir='$tgl_lahir',alamat='$alamat' WHERE id='$id' ", " muzaqi ");
                                echo"<html><head><title></title><meta http-equiv='refresh' content='2;URL=?act=ListMuzaqi'></head><body></body></html>";
                                break;
                        }
