   ...
   <?php
        ...
        if(mysql_num_rows($hasil)!=0) {
            echo "<table width='5000px' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                    <caption><h2 class=title><font color='999999'>Laporan Penggajian Karyawan Tahun ".$tahun." Bulan ".$bulan."</font></h2></caption>
                    <tr class='head'>
                         ...
                         <td width='760px'><div align='center'><font size='2' face='Verdana'><strong>Tambahan Gaji Diterima</strong></font></div></td>
				...
				$jm=$baris24[0];
				  ...
				  <td>
					 ...
					 <TD>$ttlindex</TD>
					     ...
					     echo "<tr class='isi3'><td width='150px'>$baris30[0]</td><td>: ".formatDuit($baris30[1])."</td></tr>";
				         }
                                   echo " </table>
                                         </TD>
                                         <TD>-</TD>
