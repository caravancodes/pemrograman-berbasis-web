...
<div id="post">
    <h1 class="title">::[ Input Anak Yatim ]::</h1>
        ...
        <form name="frm_unit" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            <?php
                ...
                if($action == "TAMBAH"){
                    ...
                    $_sql         	= "SELECT * FROM yatim WHERE id='$id'";
            ...
            <table width="100%" align="center">
                <tr class="head">
                    <td width="25%" >Nama Anak Yatim</td><td width="">:</td>
		...
		<tr class="head">
		    ...
		    $id             = trim($_POST['id']);
                    ...
                    if ((!empty($nama))&&(!empty($jk))&&(!empty($pendidikan))&&(!empty($tmp_lahir))
                        ...
                        switch($_GET['action']) {
                            case "TAMBAH":
                                Tambah(" yatim ","'','$nama','$jk','$pendidikan','$tmp_lahir','$tgl_lahir','$alamat'", " anak yatim " );
                                echo"<html><head><title></title><meta http-equiv='refresh' content='1;URL=?act=InputYatim&action=TAMBAH'></head><body></body></html>";
                                break;
                            case "UBAH":
                                Ubah(" yatim "," nama='$nama',jk='$jk',pendidikan='$pendidikan',
					tmp_lahir='$tmp_lahir',tgl_lahir='$tgl_lahir',alamat='$alamat' WHERE id='$id' ", " anak yatim ");
                                echo"<html><head><title></title><meta http-equiv='refresh' content='2;URL=?act=ListYatim'></head><body></body></html>";
                                break;
                        }
