...
<div id="post">
    <h1 class="title">:: Data Jabatan Struktural ::</h1>
    <div class="entry">   
    ...
    <?php
        ...
        $_sql = "SELECT kode,nama FROM jbtn_struktural ORDER BY kode ASC LIMIT $awal,20";
        ...
        if(mysql_num_rows($hasil)!=0) {
            echo "<table width='600px' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                    <tr class='head'>
                        ...
                        <td width='57%'><div align='center'><font size='2' face='Verdana'><strong>Jabatan Struktural</strong></font></div></td>
                    ...
                    while($baris = mysql_fetch_array($hasil)) {
                        echo "<tr class='isi'>
                                ...
                                <td width='120'>
                                    <center>
                                        <a href=?act=InputStruktural&action=UBAH&kode=$baris[0]>edit</a>";?>
                                        <a href="?act=ListStruktural&action=HAPUS&kode=<?php print $baris[0] ?>" onClick="if (!confirm('Anda yakin menghapus data struktural <?php print $baris[1]?>?')) return false;">| hapus</a>
                            <?php
                            echo "</center>
                               </td>
                             </tr>";
        ...
        } else {echo "<b>Data Jabatan Struktural masih kosong !</b>";}
    ...
    <?php
        if(mysql_num_rows($hasil)!=0) {
            ...
            for($j=1;$j<=$i;$j++){
                 $awal=(($j-1)*19+$j)-1;
                 echo("<a href='?act=ListStruktural&awal=$awal&page=$j'>[$j]</a>");
            }
        }
    ?>
    </div>
