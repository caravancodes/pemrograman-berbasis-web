...
$sql_head_exe = mysqli_query($sql_head);
$head_id_ujian = array();
while($head = mysqli_fetch_assoc($sql_head_exe)){
...
$sql_nilai_exe = mysqli_query($sql_nilai);
while($data = mysqli_fetch_assoc($sql_nilai_exe)){
...
while($data = mysqli_fetch_assoc($sql_siswa_exe)){
	...
	$sql_nilai_exe = mysqli_query($sql_nilai);
	$temp_arr = array();
	while($d_nilai = mysqli_fetch_assoc($sql_nilai_exe)){
