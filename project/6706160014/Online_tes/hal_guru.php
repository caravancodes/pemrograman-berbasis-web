...
if($_SESSION["level_kj"] != "guru"){
	echo "<div class='peringatan'>hanya untuk guru, area terlarang untuk anda .....<a href='index.php'>Kembali</a></div>";	
	echo "<style>
	.peringatan{
...
<html>
<head>
<title>Guru | Ujian Online - SMK HIdayatullah Samarinda</title>
        <!-- Bootstrap -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
							...
							<li class="menu_awal"><a onclick="return load_menu(this)" href="daftar_mp_ajar.php"><i class="icon-th-list"></i> Daftar Ujian</a></li>
							<li class="menu_awal"><a onclick="return load_menu(this)" href="daftar_nilai_kelas.php"><i class="icon-book"></i> Lihat Nilai</a></li>
	                    </ul>
                    </div>
                    <!--/.nav-collapse -->
                </div>
