  ...
  */
  var keywords = function(){
    ...
    [ "zend_version", "func_num_args", "func_get_arg", "func_get_args", "strlen",
      ...
      "mbereg_search_getpos", "mbereg_search_setpos", "mysqli_connect",
      "mysqli_pconnect", "mysqli_close", "mysqli_select_db", "mysqli_query",
      "mysqli_unbuffered_query", "mysqli_db_query", "mysqli_list_dbs",
      "mysqli_list_tables", "mysqli_list_fields", "mysqli_list_processes",
      "mysqli_error", "mysqli_errno", "mysqli_affected_rows", "mysqli_insert_id",
      "mysqli_result", "mysqli_num_rows", "mysqli_num_fields", "mysqli_fetch_row",
      "mysqli_fetch_array", "mysqli_fetch_assoc", "mysqli_fetch_object",
      "mysqli_data_seek", "mysqli_fetch_lengths", "mysqli_fetch_field",
      "mysqli_field_seek", "mysqli_free_result", "mysqli_field_name",
      "mysqli_field_table", "mysqli_field_len", "mysqli_field_type",
      "mysqli_field_flags", "mysqli_escape_string", "mysqli_real_escape_string",
      "mysqli_stat", "mysqli_thread_id", "mysqli_client_encoding", "mysqli_ping",
      "mysqli_get_client_info", "mysqli_get_host_info", "mysqli_get_proto_info",
      "mysqli_get_server_info", "mysqli_info", "mysqli_set_charset", "mysqli",
      "mysqli_fieldname", "mysqli_fieldtable", "mysqli_fieldlen", "mysqli_fieldtype",
      "mysqli_fieldflags", "mysqli_selectdb", "mysqli_freeresult", "mysqli_numfields",
      "mysqli_numrows", "mysqli_listdbs", "mysqli_listtables", "mysqli_listfields",
      "mysqli_db_name", "mysqli_dbname", "mysqli_tablename", "mysqli_table_name",
      "mysqlii_affected_rows", "mysqlii_autocommit", "mysqlii_change_user",
      "mysqlii_character_set_name", "mysqlii_close", "mysqlii_commit", "mysqlii_connect",
      "mysqlii_connect_errno", "mysqlii_connect_error", "mysqlii_data_seek",
      "mysqlii_debug", "mysqlii_disable_reads_from_master", "mysqlii_disable_rpl_parse",
      "mysqlii_dump_debug_info", "mysqlii_enable_reads_from_master",
      "mysqlii_enable_rpl_parse", "mysqlii_embedded_server_end",
      "mysqlii_embedded_server_start", "mysqlii_errno", "mysqlii_error",
      "mysqlii_stmt_execute", "mysqlii_execute", "mysqlii_fetch_field",
      "mysqlii_fetch_fields", "mysqlii_fetch_field_direct", "mysqlii_fetch_lengths",
      "mysqlii_fetch_array", "mysqlii_fetch_assoc", "mysqlii_fetch_object",
      "mysqlii_fetch_row", "mysqlii_field_count", "mysqlii_field_seek",
      "mysqlii_field_tell", "mysqlii_free_result", "mysqlii_get_charset",
      "mysqlii_get_client_info", "mysqlii_get_client_version", "mysqlii_get_host_info",
      "mysqlii_get_proto_info", "mysqlii_get_server_info", "mysqlii_get_server_version",
      "mysqlii_get_warnings", "mysqlii_init", "mysqlii_info", "mysqlii_insert_id",
      "mysqlii_kill", "mysqlii_set_local_infile_default",
      "mysqlii_set_local_infile_handler", "mysqlii_master_query",
      "mysqlii_more_results", "mysqlii_multi_query", "mysqlii_next_result",
      "mysqlii_num_fields", "mysqlii_num_rows", "mysqlii_options", "mysqlii_ping",
      "mysqlii_prepare", "mysqlii_report", "mysqlii_query", "mysqlii_real_connect",
      "mysqlii_real_escape_string", "mysqlii_real_query", "mysqlii_rollback",
      "mysqlii_rpl_parse_enabled", "mysqlii_rpl_probe", "mysqlii_rpl_query_type",
      "mysqlii_select_db", "mysqlii_set_charset", "mysqlii_stmt_attr_get",
      "mysqlii_stmt_attr_set", "mysqlii_stmt_field_count", "mysqlii_stmt_init",
      "mysqlii_stmt_prepare", "mysqlii_stmt_result_metadata",
      "mysqlii_stmt_send_long_data", "mysqlii_stmt_bind_param",
      "mysqlii_stmt_bind_result", "mysqlii_stmt_fetch", "mysqlii_stmt_free_result",
      "mysqlii_stmt_get_warnings", "mysqlii_stmt_insert_id", "mysqlii_stmt_reset",
      "mysqlii_stmt_param_count", "mysqlii_send_query", "mysqlii_slave_query",
      "mysqlii_sqlstate", "mysqlii_ssl_set", "mysqlii_stat",
      "mysqlii_stmt_affected_rows", "mysqlii_stmt_close", "mysqlii_stmt_data_seek",
      "mysqlii_stmt_errno", "mysqlii_stmt_error", "mysqlii_stmt_num_rows",
      "mysqlii_stmt_sqlstate", "mysqlii_store_result", "mysqlii_stmt_store_result",
      "mysqlii_thread_id", "mysqlii_thread_safe", "mysqlii_use_result",
      "mysqlii_warning_count", "mysqlii_bind_param", "mysqlii_bind_result",
      "mysqlii_client_encoding", "mysqlii_escape_string", "mysqlii_fetch",
      "mysqlii_param_count", "mysqlii_get_metadata", "mysqlii_send_long_data",
      "mysqlii_set_opt", "pdo_drivers", "socket_select", "socket_create",
      ...
      "mcrypt_module_close","mysqlii_refresh","posix_kill","posix_getpid","posix_getppid",
    ...
    [ "E_ERROR", "E_RECOVERABLE_ERROR", "E_WARNING", "E_PARSE", "E_NOTICE",
      ...
      "mysqli_CLIENT_IGNORE_SPACE", "mysqliI_READ_DEFAULT_GROUP",
      "mysqliI_READ_DEFAULT_FILE", "mysqliI_OPT_CONNECT_TIMEOUT",
      "mysqliI_OPT_LOCAL_INFILE", "mysqliI_INIT_COMMAND", "mysqliI_CLIENT_SSL",
      "mysqliI_CLIENT_COMPRESS", "mysqliI_CLIENT_INTERACTIVE",
      "mysqliI_CLIENT_IGNORE_SPACE", "mysqliI_CLIENT_NO_SCHEMA",
      "mysqliI_CLIENT_FOUND_ROWS", "mysqliI_STORE_RESULT", "mysqliI_USE_RESULT",
      "mysqliI_ASSOC", "mysqliI_NUM", "mysqliI_BOTH",
      "mysqliI_STMT_ATTR_UPDATE_MAX_LENGTH", "mysqliI_STMT_ATTR_CURSOR_TYPE",
      "mysqliI_CURSOR_TYPE_NO_CURSOR", "mysqliI_CURSOR_TYPE_READ_ONLY",
      "mysqliI_CURSOR_TYPE_FOR_UPDATE", "mysqliI_CURSOR_TYPE_SCROLLABLE",
      "mysqliI_STMT_ATTR_PREFETCH_ROWS", "mysqliI_NOT_NULL_FLAG",
      "mysqliI_PRI_KEY_FLAG", "mysqliI_UNIQUE_KEY_FLAG", "mysqliI_MULTIPLE_KEY_FLAG",
      "mysqliI_BLOB_FLAG", "mysqliI_UNSIGNED_FLAG", "mysqliI_ZEROFILL_FLAG",
      "mysqliI_AUTO_INCREMENT_FLAG", "mysqliI_TIMESTAMP_FLAG", "mysqliI_SET_FLAG",
      "mysqliI_NUM_FLAG", "mysqliI_PART_KEY_FLAG", "mysqliI_GROUP_FLAG",
      "mysqliI_TYPE_DECIMAL", "mysqliI_TYPE_TINY", "mysqliI_TYPE_SHORT",
      "mysqliI_TYPE_LONG", "mysqliI_TYPE_FLOAT", "mysqliI_TYPE_DOUBLE",
      "mysqliI_TYPE_NULL", "mysqliI_TYPE_TIMESTAMP", "mysqliI_TYPE_LONGLONG",
      "mysqliI_TYPE_INT24", "mysqliI_TYPE_DATE", "mysqliI_TYPE_TIME",
      "mysqliI_TYPE_DATETIME", "mysqliI_TYPE_YEAR", "mysqliI_TYPE_NEWDATE",
      "mysqliI_TYPE_ENUM", "mysqliI_TYPE_SET", "mysqliI_TYPE_TINY_BLOB",
      "mysqliI_TYPE_MEDIUM_BLOB", "mysqliI_TYPE_LONG_BLOB", "mysqliI_TYPE_BLOB",
      "mysqliI_TYPE_VAR_STRING", "mysqliI_TYPE_STRING", "mysqliI_TYPE_CHAR",
      "mysqliI_TYPE_INTERVAL", "mysqliI_TYPE_GEOMETRY", "mysqliI_TYPE_NEWDECIMAL",
      "mysqliI_TYPE_BIT", "mysqliI_RPL_MASTER", "mysqliI_RPL_SLAVE", "mysqliI_RPL_ADMIN",
      "mysqliI_NO_DATA", "mysqliI_DATA_TRUNCATED", "mysqliI_REPORT_INDEX",
      "mysqliI_REPORT_ERROR", "mysqliI_REPORT_STRICT", "mysqliI_REPORT_ALL",
      "mysqliI_REPORT_OFF", "AF_UNIX", "AF_INET", "AF_INET6", "SOCK_STREAM",
    ...
    [  "stdClass", "Exception", "ErrorException", "COMPersistHelper", "com_exception",
      ...
      "XMLReader", "XMLWriter", "mysqlii_sql_exception", "mysqlii_driver", "mysqlii",
      "mysqlii_warning", "mysqlii_result", "mysqlii_stmt", "PDOException", "PDO",
