...
$soal_terakhir_exe = mysqli_query("select id_soal from soal where id_ujian='".$id_ujian."' order by id_soal");
$jum_soal = mysqli_num_rows($soal_terakhir_exe);
if($jum_soal > 0){
	// cari id_soal terakhir
	$arr_temp = array();
	while($data_soal = mysqli_fetch_assoc($soal_terakhir_exe)){
